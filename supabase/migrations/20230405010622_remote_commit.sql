...
--
-- Name: arkive; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."arkive" (
    "id" bigint NOT NULL,
...
ALTER TABLE "public"."arkive" OWNER TO "postgres";

--
-- Name: arkive_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE "public"."arkive" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."arkive_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE "public"."deployments" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "major_version" bigint DEFAULT '1'::bigint NOT NULL,
    "minor_version" bigint DEFAULT '0'::bigint NOT NULL,
    "status" "text" DEFAULT ''::"text",
    "arkive_id" bigint NOT NULL,
    "file_path" "text"
);
...
--
-- Name: arkive arkive_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."arkive"
    ADD CONSTRAINT "arkive_pkey" PRIMARY KEY ("id");
...
--
-- Name: user_profile user_data_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_profile user_data_username_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: arkive arkive_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."arkive"
    ADD CONSTRAINT "arkive_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: deployments deployments_arkive_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."deployments"
    ADD CONSTRAINT "deployments_arkive_id_fkey" FOREIGN KEY ("arkive_id") REFERENCES "public"."arkive"("id");
...
--
-- Name: deployments Allow only owner of arkive; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow only owner of arkive" ON "public"."deployments" USING (("auth"."uid"() IN ( SELECT "arkive"."user_id"
   FROM "public"."arkive"
  WHERE ("arkive"."id" = "deployments"."arkive_id")))) WITH CHECK (("auth"."uid"() IN ( SELECT "arkive"."user_id"
   FROM "public"."arkive"
  WHERE ("arkive"."id" = "deployments"."arkive_id"))));


--
-- Name: arkive Allow owners only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow owners only" ON "public"."arkive" TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: user_profile Enable crud for owners; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable crud for owners" ON "public"."user_profile" USING (("auth"."uid"() = "id")) WITH CHECK (("auth"."uid"() = "id"));
...
--
-- Name: arkive Enable read access for all users to public arkives; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users to public arkives" ON "public"."arkive" FOR SELECT USING (("public" = true));


--
-- Name: deployments Enable read access for public arkives; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for public arkives" ON "public"."deployments" FOR SELECT USING ((( SELECT "arkive"."public"
   FROM "public"."arkive"
  WHERE ("arkive"."id" = "deployments"."arkive_id")) = true));


--
-- Name: arkive; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."arkive" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: TABLE "arkive"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."arkive" TO "anon";
GRANT ALL ON TABLE "public"."arkive" TO "authenticated";
GRANT ALL ON TABLE "public"."arkive" TO "service_role";


--
-- Name: SEQUENCE "arkive_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."arkive_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."arkive_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."arkive_id_seq" TO "service_role";
...
--
-- Name: SEQUENCE "deployments_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
